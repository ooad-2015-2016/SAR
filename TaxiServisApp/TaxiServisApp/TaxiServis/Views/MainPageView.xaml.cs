...
namespace TaxiServisApp.TaxiServis.Views
{
   ...
   int brojUloga=0;
            ...
            if (stavke == null && korisnik != null && korisnik.UlogaKorisnika != null)
            {
                ...
                funkcijaProvjere(stavkeFiltriranoOdDuplikata, brojUloga, brojMS);
                MeniStavkeListView.ItemsSource = stavkeFiltriranoOdDuplikata;
                

            }
        }
        public async void funkcijaProvjere(List<MeniStavkeViewModel> lS, int brojUloga, int brojUlogaMeniStavka)
        {
