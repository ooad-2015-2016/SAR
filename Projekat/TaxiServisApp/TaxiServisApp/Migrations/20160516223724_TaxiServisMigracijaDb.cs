...
{
    public partial class TaxiServisMigracijaDb : Migration
    {
            ...
            migration.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        referencedColumn: "id");
                    table.ForeignKey(
                        name: "FK_NarudzbaOdmah_Klijent_klijentid",
                        columns: x => x.klijentid,
                        referencedTable: "Klijent",
                        referencedColumn: "id");
                    table.ForeignKey(
                        name: "FK_NarudzbaOdmah_Lokacija_odredisteid",
            ...
            migration.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        referencedColumn: "id");
                    table.ForeignKey(
                        name: "FK_Rezervacija_Lokacija_odredisteid",
                        columns: x => x.odredisteid,
                        referencedTable: "Lokacija",
                        referencedColumn: "id");
                    table.ForeignKey(
