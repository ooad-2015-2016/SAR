    ...
    public partial class InitialMigration : Migration
    {
        public override void Up(MigrationBuilder migration)
        {
            migration.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cijenovnik", x => x.id);
                });
            migration.CreateTable(
                name: "Dispecer",
                columns: table => new
            ...
            migration.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column(type: "INTEGER", nullable: false)
                        ,//.Annotation("Sqlite:Autoincrement", true),
                    LokacijaKrajnjaid = table.Column(type: "INTEGER", nullable: true),
                    LokacijaPocetnaid = table.Column(type: "INTEGER", nullable: true),
                    Lokacijaid = table.Column(type: "INTEGER", nullable: true),
                    RegistrovaniKlijentid = table.Column(type: "INTEGER", nullable: true),
                    VozacPrihvatioId = table.Column(type: "INTEGER", nullable: false),
                    Vozacid = table.Column(type: "INTEGER", nullable: true),
                    ...
                    klijentId = table.Column(type: "INTEGER", nullable: false),
                    krajnjaLokacijaId = table.Column(type: "INTEGER", nullable: false),
                    lokacijaKorisikaId = table.Column(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rezervacija_Lokacija_LokacijaKrajnjaid",
                        columns: x => x.LokacijaKrajnjaid,
                        referencedTable: "Lokacija",
                        referencedColumn: "id");
                    table.ForeignKey(
                        name: "FK_Rezervacija_Lokacija_LokacijaPocetnaid",
                        columns: x => x.LokacijaPocetnaid,
                        referencedTable: "Lokacija",
                        referencedColumn: "id");
                    table.ForeignKey(
        ...
        public override void Down(MigrationBuilder migration)
        {
            ...
            migration.DropTable("Cijenovnik");
