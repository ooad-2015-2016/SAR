...
// <summary>
    ...
    public sealed partial class PocetnaDispecerView : Page
    {
        ...
        public PocetnaDispecerView()
        {
            ...
            dispecer_MapControl.MapElements.Add(mojaLokacijaMapIcon);
            dispecer_MapControl.MapElements.Add(pocetnaLokacijaMapIcon);
            dispecer_MapControl.MapElements.Add(krajnjaLokacijaMapIcon);
            ...
            {
                {
                    ...
                    await dispecer_MapControl.TrySetViewAsync(geoposition.Coordinate.Point);
        ...
        {
            dispecer_MapControl.Routes.Clear();
            samoPolazna = true;
            polazna_radioButton.IsChecked = true;
            polazna_radioButton.Visibility = Visibility.Visible;
            ...
            if (pocetnaLokacijaMapIcon.Visible == true && krajnjaLokacijaMapIcon.Visible == true && samoPolazna == false)
            {
                ...
                if (pocetnaLokacijaMapIcon.Location != null && krajnjaLokacijaMapIcon.Location != null)
                {
                    ...
                    if (routeResult.Status == MapRouteFinderStatus.Success)
                    {
                        ...
                        dispecer_MapControl.Routes.Clear();
                        if (dispecer_MapControl.Routes.Count() > 0)
                            dispecer_MapControl.Routes.RemoveAt(0);
                        dispecer_MapControl.Routes.Add(viewOfRoute);
        ...
        private void button_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                ispisPoruka("Uspjesno ste kreirali narudzbu. ", "Uspjesna rezervacija");
            }
        }
